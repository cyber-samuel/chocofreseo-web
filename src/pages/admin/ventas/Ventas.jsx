                ...
                {carrito.map((item) => {
                  ...
                  return (
                    <div key={item.lineaId} className="carrito-item">
                      ...
                      {item.chocolate && <span style={{ background: item.chocolate==='Negro' ? '#4b5563' : '#f5f0e8', color: item.chocolate==='Negro' ? '#fff' : '#78716c', fontSize: 10, fontWeight: 700, padding: '1px 7px', borderRadius: 20, display: 'inline-block', marginTop: 2 }}>Chocolate {item.chocolate}</span>}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 8 }}>
                {venta.detalleVentas.map((d, i) => {
                  ...
                  <div key={i} style={{ background: '#fafafa', borderRadius: 8, padding: '10px 12px', border: '1px solid #f0f0f0' }}>
                    ...
                    {d.chocolate && (
                      <span style={{ background: d.chocolate==='Negro' ? '#4b5563' : '#f5f0e8', color: d.chocolate==='Negro' ? '#fff' : '#78716c', fontSize: 11, padding: '2px 9px', borderRadius: 20, fontWeight: 600, display: 'inline-block', marginTop: 4 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 16 }}>
          {carrito.map((item) => (
            <div key={item.lineaId} style={{ background: '#fafafa', border: '1px solid #f0f0f0', borderRadius: 10, padding: '10px 12px' }}>
              ...
              {item.chocolate && <span style={{ background: item.chocolate==='Negro' ? '#4b5563' : '#f5f0e8', color: item.chocolate==='Negro' ? '#fff' : '#78716c', fontSize: 10, padding: '1px 7px', borderRadius: 20, fontWeight: 600, display: 'inline-block', marginTop: 3 }}>Chocolate {item.chocolate}</span>}
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4, marginTop: 4 }}>
