export const LogoWhatsApp = ({ size = 20, color = '#25D366' }) => (
...
export const LogoInstagram = ({ size = 20, color = null }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color || 'url(#igGrad)'}>
    {!color && (
      <defs>
...
export const LogoTikTok = ({ size = 20, color = '#000' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
...
export const LogoFacebook = ({ size = 20, color = '#1877F2' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
